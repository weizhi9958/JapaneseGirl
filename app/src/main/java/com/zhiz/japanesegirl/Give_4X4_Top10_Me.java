 ...
 */
public class Give_4X4_Top10_Me extends Fragment {
    ...
    private static String url_all_data = "http://wesley.huhu.tw/japan/get_me4x4top10_data.php";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        sUserName = bundle.getString(TAG_NAME);
